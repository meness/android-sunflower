...
import com.purpletealabs.stores.utilities.getValue
import com.purpletealabs.stores.utilities.testCalendar
import com.purpletealabs.stores.utilities.testGardenPlanting
import com.purpletealabs.stores.utilities.testPlant
import com.purpletealabs.stores.utilities.testPlants
...
class GardenPlantingDaoTest {
    ...
    fun testGetGardenPlanting() {
        assertThat(
            getValue(
                gardenPlantingDao.getGardenPlanting(
    ...
    fun testGetGardenPlantingForPlant() {
        assertThat(
            getValue(
                gardenPlantingDao.getGardenPlantingForPlant(
                    testPlant.plantId
                )
            ),
            equalTo(testGardenPlanting)
    ...
    fun testGetPlantAndGardenPlantings() {
        val plantAndGardenPlantings =
            getValue(gardenPlantingDao.getPlantAndGardenPlantings())
